    ...
    <body class="skin-blue">
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="../../index2.html" class="logo"><b>1Way</b> HELP DESK</a>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">wan way communication</span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            wan way communication - Web Developer
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="ticket.html">
                                <i class="fa fa-envelope"></i> <span>Inbox</span> <small class="label pull-right bg-#15c315">5</small>
                            </a>
                        </li>
                        <li>
                            <a href="../widgets.html">
                                <i class="fa fa-user"></i> <span>My Tickets</span> <small class="label pull-right bg-#15c315">2</small>
                            </a>
                        </li>
                        <li>
                            <a href="../widgets.html">
                                <i class="fa fa-th"></i> <span>Unassigned</span> <small class="label pull-right bg-#15c315">4</small>
                            </a>
                        </li>
                        <li>
                            <a href="../widgets.html">
                                <i class="fa fa-trash-o"></i> <span>Trash</span> <small class="label pull-right bg-#15c315">89</small>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href=""><i class="fa fa-circle-o"></i>Open<small class="label pull-right bg-#15c315">4</small></a></li>
                                <li><a href=""><i class="fa fa-circle-o"></i>Inprogress<small class="label pull-right bg-#15c315">3</small></a></li>
                                <li><a href=""><i class="fa fa-circle-o"></i>Closed<small class="label pull-right bg-#15c315">55</small></a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href=""><i class="fa fa-circle-o"></i>Open<small class="label pull-right bg-#15c315">1</small></a></li>
                                <li><a href=""><i class="fa fa-circle-o"></i>Inprogress<small class="label pull-right bg-#15c315">6</small></a></li>
                                <li><a href=""><i class="fa fa-circle-o"></i>Closed<small class="label pull-right bg-#15c315">88</small></a></li>
                            </ul>
                        </li>
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <div class="pull-right">
                                <button type="button" class="btn btn-default"><i class="fa fa-edit" style="color:#15c315;"> </i> Edit</button>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="#"><i class="fa fa-check" style="color:#15c315;"> </i>Closed</a></li>
                                        <li><a href="#"><i class="fa fa-check-circle-o " style="color:#15c315;"> </i> Resolved</a></li>
                                    </ul>
                                </div>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#"><i class="fa fa-users" style="color:#15c315;"> </i>Change Owner</a></li>
                        ...
                        <div class='col-xs-12'>
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#General" data-toggle="tab" style="color:#15c315;"><i class="fa fa-reply-all"> </i> Reply</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="General">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-default"><i class="fa fa-check-square-o" style="color:#15c315;"> </i> Update</button>
                                    ...
                                    <div class="tab-pane" id="Reply" >
                                        <div class="form-group">
                                            <button type="button" class="btn btn-default"><i class="fa fa-mail-forward" style="color:#15c315;"> </i> Send</button>
