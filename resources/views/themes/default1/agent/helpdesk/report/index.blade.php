...
<li>
    <a href="">
        <i class="fa fa-area-chart"></i> <span>{!! Lang::get('lang.help_topic') !!}</span> <small class="label pull-right bg-#15c315"></small>
    </a>
</li>
<li>
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-xs-6">
                <div class="description-block">
                    <h3><span class="description-percentage text-#15c315" ><i class="fa fa-file-text-o"> </i> <small class="text-#15c315"><i class="fa fa-times"> </i></small> <span id="total-closed-tickets"> </span> </span></h3>
