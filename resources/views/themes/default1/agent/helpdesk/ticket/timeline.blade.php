    ...
    <div class="box-header">
        ...
        <div class="pull-right">
            ...
            if ($group->can_edit_ticket == 1) {
                ?>
                <button type="button" class="btn btn-sm btn-default" id="Edit_Ticket" data-toggle="modal" data-target="#Edit"><i class="fa fa-edit" style="color:#15c315;"> </i> {!! Lang::get('lang.edit') !!}</button>
            <?php } ?>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                  ...
                  @if(Auth::user()->role == 'admin')
                    ...
                    <li id="close"><a href="#"><i class="fa fa-check" style="color:#15c315;"> </i>{!! Lang::get('lang.close') !!}</a></li>
                    <?php } ?>
                     <?php } ?>
                    ...
                    <?php } ?>
                     <?php } ?>
                    <li id="resolved"><a href="#"><i class="fa fa-check-circle-o " style="color:#15c315;"> </i>{!! Lang::get('lang.resolved') !!} </a></li>
                </ul>
            </div>
            <?php if ($group->can_delete_ticket == 1 || $group->can_ban_email == 1) { ?>
                <div id="more-option" class="btn-group">
                    ...
                    <ul  class="dropdown-menu pull-right">
                        <li data-toggle="modal" data-target="#ChangeOwner"><a href="#"><i class="fa fa-users" style="color:#15c315;"> </i>Change Owner</a></li>
    ...
    <div class="modal fade" id="ChangeOwner">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#ahah1" data-toggle="tab" style="color:#15c315;" id="aa"><i class="fa fa-users"> </i> {!! Lang::get('lang.search_existing_users') !!}</a></li>
    ...
    <div class="modal fade" id="addccc">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#ahah" data-toggle="tab" style="color:#15c315;" id="aa"><i class="fa fa-users"> </i> {!! Lang::get('lang.search_existing_users') !!}</a></li>
