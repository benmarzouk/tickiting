...
<div class="box box-info">
    ...
    <div class="box-body">
        ...
        <button type="button" class="btn btn-sm btn-default text-#15c315" id="Edit_Ticket" data-toggle="modal" data-target="#MergeTickets"><i class="fa fa-code-fork"> </i> {!! Lang::get('lang.merge') !!}</button>
