        ...
        <div class="box box-primary" >
            ...
            <div class="box-footer">
                <div id="refresh-org">
                    ...
                    <a href=""   data-toggle="modal" data-target="#editassign" title="{{$organization->name}}"> <span style="color:#15c315;">{{str_limit($organization->name,15)}}</span> </a>
            ...
            <div class="box-footer">
                ...
                <a class="pull-right">
                    ...
                    <span style="color:#15c315;">{!! $users->role !!}</span>
            ...
            <div class="box-footer">
                ...
                <a class="pull-right">
                    @if($users->active == '1')
                    <span style="color:#15c315;"> <span class="glyphicon glyphicon-ok-circle"></span>  <span class="glyphicon glyphicon-user"></span></span>
                    @else
        ...
        <div id="more-option" class="btn-group">
            <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" id="d2">
                ...
                <ul  class="dropdown-menu pull-right">
                    <li data-toggle="modal" data-target="#ChangeOwner"><a href="#" class="toggle-vis" data-column="7"><i class="fa fa-plus-square-o" style="color:#15c315;"> </i>{!!Lang::get('lang.created-at')!!}</a></li>
                </ul>
        </div>
                                        </div>
