...
<html>
    <head>
        ...
        <style type="text/css">
            #bar {
                border-right: 1px solid #357ca5a(204, 204, 204, 0.41);
            }
            #bar a{
                color: #fff;
            }
                    ...
                    <ul id="side-bar" class="sidebar-menu">
                        ...
                        <li @yield('trash')>
                             <a href="{{url('/tickets?show=trash')}}">
                                ...
                                <small class="label pull-right bg-#15c315">{{$deleted -> count()}}</small>
                            </a>
                        </li>
            ...
            ?>
                        ...
                        <li class="treeview @if($dept2 === $name) @yield('ticket-bar') @endif ">
                           ...
                           <ul class="treeview-menu">
                                <li @if($status2 == $dept->get($status)->status && $dept2 === $name) @yield('inbox') @endif><a href="{!! url('tickets?departments='.$name.'&status='.$dept->get($status)->status) !!}"><i class="fa fa-circle-o"></i> {!!$dept->get($status)->status !!}<small class="label pull-right bg-#15c315">{{$dept->get($status)->count}}</small></a></li>
                            </ul>
                           @endif
                            @endforeach
...
?>
            ...
            <div class="content-wrapper">
                ...
                <div class="tab-content" style="background-color: #3c8dbc; position: fixed; width:100% ;padding: 0 0px 0 0px; z-index:999">
                    <div class="collapse navbar-collapse" id="navbar-collapse">
