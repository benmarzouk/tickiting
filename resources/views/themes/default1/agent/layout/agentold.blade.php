                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse">
                        ...
                        <ul class="tabs tabs-horizontal nav navbar-nav navbar-left">
                            <li @yield(' Tableau_De_Bord')><a id="dash" data-target="#tabA" href="{{URL::route(' Tableau_De_Bord')}}" onclick="click Tableau_De_Bord(event);">{!! Lang::get('lang. Tableau_De_Bord') !!}</a></li>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <!-- Menu Footer-->
                                <li class="user-footer" style="background-color:#307196;">
                                    <div class="pull-left">
                       ...
                       @if($settings->status == 1)
                        <li @yield('approval')>
                             <a href="{{url('ticket/approval/closed')}}" id="load-unassigned">
                                ...
                                <small class="label pull-right bg-#15c315">{{count($closingapproval)}}</small>
                            </a>
                        </li>
                        @endif
                        <li @yield('trash')>
                             <a href="{{url('trash')}}">
                                ...
                                <small class="label pull-right bg-#15c315">{{count($deleted)}}</small>
                            </a>
                        </li>
                            ...
                            if (Auth::user()->role == 'admin') {
                                ...
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="{!! url::route('dept.open.ticket',$dept->name) !!}"><i class="fa fa-circle-o"></i>{!! Lang::get('lang.open') !!}<small class="label pull-right bg-#15c315">{!! $open !!}</small></a></li>
                                        <li><a href="{!! url::route('dept.inprogress.ticket',$dept->name) !!}"><i class="fa fa-circle-o"></i>{!! Lang::get('lang.assigned') !!}<small class="label pull-right bg-#15c315">{!! $underprocess !!}</small></a></li>
                                        <li><a href="{!! url::route('dept.closed.ticket',$dept->name) !!}"><i class="fa fa-circle-o"></i>{!! Lang::get('lang.closed') !!}<small class="label pull-right bg-#15c315">{!! $closed !!}</small></a></li>
                                    </ul>
                                </li>
...
<script type="text/javascript">
    function click Tableau_De_Bord(e) {
        if (e.ctrlKey === true) {
            window.open('{{URL::route(" Tableau_De_Bord")}}', '_blank');
        } else {
            window.location = "{{URL::route(' Tableau_De_Bord')}}";
        }
    }
