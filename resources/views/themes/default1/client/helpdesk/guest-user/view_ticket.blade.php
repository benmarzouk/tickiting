...
<div class="box box-primary">
    <div class="box-header">
        ...
        <div class="pull-right">
            ...
            <button type="button" class="btn btn-default" id="Edit_Ticket" data-toggle="modal" data-target="#Edit"><i class="fa fa-edit" style="color:#15c315;"> </i> Edit</button>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li id="close"><a href="#"><i class="fa fa-check" style="color:#15c315;"> </i>Close</a></li>

                    <li id="resolved"><a href="#"><i class="fa fa-check-circle-o " style="color:#15c315;"> </i> Resolved</a></li>
                </ul>
            </div>
    ...
    <div class='col-xs-12'>
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#General" data-toggle="tab" style="color:#15c315;" id="aa"><i class="fa fa-reply-all"> </i> Reply</a></li>
