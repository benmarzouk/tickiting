     ...
     ?>
                                        <li>
                                            <a href="{{ url('/ticket/open') }}">
                                                <i class="fa fa-envelope"></i> <span>Inbox</span> <small class="label pull-right bg-#15c315"><?php echo $i;?></small>
                                            </a>
                                        </li>
<?php
//}
		...
		?>
                                        <li class="treeview">
                                            ...
                                            <ul class="treeview-menu">
                                                <li><a href=""><i class="fa fa-circle-o"></i>Open<small class="label pull-right bg-#15c315">{!! $open !!}</small></a></li>
                                                <li><a href=""><i class="fa fa-circle-o"></i>Inprogress<small class="label pull-right bg-#15c315">{!! $underprocess !!}</small></a></li>
                                                <li><a href=""><i class="fa fa-circle-o"></i>Closed<small class="label pull-right bg-#15c315">{!! $closed !!}</small></a></li>
                                            </ul>
                                        </li>
